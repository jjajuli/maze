...
class MazeGame(tk.Tk):
    def __init__(self, rows: int = 7, cols: int = 7, cell_size: int = 36):
        ...
        self.falls_var = tk.StringVar(value="Golpes: 0")
    ...
    def on_win(self):
        messagebox.showinfo("¡Llegaste!", f"Has alcanzado la meta. Golpes totales: {self.falls}")
    ...
    def update_falls_label(self):
        self.falls_var.set(f"Golpes: {self.falls}")
